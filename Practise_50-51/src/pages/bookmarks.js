...
export function Bookmarks() {
  ...
  const loadMovies = () => {
    if (currentMovies.length == 0) {
      content = "<h3>You have not liked anything yet...</h3>";
    } else {
      content = "";
    ...
    <header>
      ...
      <nav>
        <button id="bookmarksButton" style="text-decoration: underline;" onclick="redirect('/bookmarks')">Bookmarks</button>
      </nav>
      <div>
        <form>
